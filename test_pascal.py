...
def train(
    ...
    np.save('./data/pascal/data/learn_' + learn + '/' + str(missing_pr) + '_cl_label.npy', category_labels)
    del category_labels
    output_images_gt = np.array(output_images_gt)
    np.save('./data/pascal/data/learn_' + learn + '/' + str(missing_pr) + '_gt.npy', output_images_gt)
    del output_images_gt
    output_images_preds = np.array(output_images_preds)
    np.save('./data/pascal/data/learn_' + learn + '/' + str(missing_pr) + '_pred.npy', output_images_preds)
    del output_images_preds
    output_images_pred_correcteds = np.array(output_images_pred_correcteds)
    np.save('./data/pascal/data/learn_'+learn+'/' + str(missing_pr) + '_corrected.npy', output_images_pred_correcteds)
