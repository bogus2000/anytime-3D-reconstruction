...
def train(
    ...
    # np.save('./data/modelnet/data_AE/learn_' + learn + '/' + str(missing_pr) + '_cl_label.npy', category_labels)
    # del category_labels
    # output_images_gt = np.concatenate(output_images_gt, axis=0)
    # np.save('./data/modelnet/data_AE/learn_' + learn + '/' + str(missing_pr) + '_gt.npy', output_images_gt)
    # del output_images_gt
    # output_images_preds = np.concatenate(output_images_preds, axis=0)
    # np.save('./data/modelnet/data_AE/learn_' + learn + '/' + str(missing_pr) + '_pred.npy', output_images_preds)
