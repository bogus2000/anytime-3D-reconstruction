...
def train(
    ...
    model = nolbo.nolboSingleObject_category_only(nolbo_structure=config,
    ...
    data_loader_pascal = pascal3D.dataLoaderSingleObject(trainOrVal='val', Pascal3DDataPath='/media/yonsei/4TB_HDD/dataset/PASCAL3D+_release1.1/')
    ...
    # np.save('./data/pascal/data_category/learn_' + learn + '/' + str(missing_pr) + '_cl_label.npy', category_labels)
    # del category_labels
    # output_images_gt = np.concatenate(output_images_gt, axis=0)
    # np.save('./data/pascal/data_category/learn_' + learn + '/' + str(missing_pr) + '_gt.npy', output_images_gt)
    # del output_images_gt
    # output_images_preds = np.concatenate(output_images_preds, axis=0)
    # np.save('./data/pascal/data_category/learn_' + learn + '/' + str(missing_pr) + '_pred.npy', output_images_preds)
    # del output_images_preds
    # output_images_pred_correcteds = np.concatenate(output_images_pred_correcteds, axis=0)
    # np.save('./data/pascal/data_category/learn_'+learn+'/' + str(missing_pr) + '_corrected.npy', output_images_pred_correcteds)
...
#         config=config,
#         load_path='./weights/pascal_category/',
#         missing_pr=0.3,
#         learn='train',
#     ))
#
